...
Before starting the [blender tutorial](https://github.com/joewdavies/geoblender/blob/master/README.md), if you want to get a DEM, mask, etc for a country, simply run DEM_prep.py with python installed and the DEM tiles added to the /input/tiles folder!
